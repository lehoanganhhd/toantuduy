	...
	if( $show_left_sidebar ) :?>
		...
		<section id="primary" class="<?php echo esc_attr($page_layout);?>">
			...
			if( have_posts() ) :
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class('blog-entry'); ?>>
							<div class="blog-entry-inner">
								<div class="entry-meta">
									<a class="blog-author" href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID')));?>">
				...
				<h2><?php esc_html_e( 'Nothing Found','dt_themes'); ?></h2>
				<h3><?php esc_html_e( "Oops!, Couldn't find what you're looking for!",'dt_themes'); ?></h3>
				<?php get_search_form();
			endif;?>
			</div>
