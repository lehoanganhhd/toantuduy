  ...
  layoutSelect : function(){
    jQuery("#page-layout").find("a").click(function(e){
      ...
      if( jQuery(".sidebar-section").length ) {
		  ...
		  } else if( $rel == "with-left-sidebar" ) {
			 jQuery("#right-widget-area").slideUp();
			 jQuery("#left-widget-area").slideDown();
		  } else if( $rel == "with-right-sidebar" ) {
			 jQuery("#left-widget-area").slideUp();
			 jQuery("#right-widget-area").slideDown();
		  } else if( $rel == "with-both-sidebar") {
			  jQuery("#right-widget-area").slideDown();
			 jQuery("#left-widget-area").slideDown();
		  }
      }
