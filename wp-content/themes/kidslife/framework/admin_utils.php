...
function dttheme_default_option() {
	...
	$general = array(
		...
		"h1-emailid" => "contact@kidslife.com",
		"copyright-text" => '&copy; 2014 Kids Life. All rights reserved. Design by <a title="" href="http://themeforest.net/user/designthemes">DesignThemes</a>');
	...
	$social = array (
		'social-1' => array('icon'=>'dribbble.png','link'=>'#'), 
		'social-2' => array('icon'=>'flickr.png','link'=>'#'),
