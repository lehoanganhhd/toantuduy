...
<?php function page_metabox(){
	...
	function page_settings($args){
        ...
        <div class="j-pagetemplate-container">
        	...
        	<div id="tpl-common-settings">
				...
				switch( $v ):
					case 'content-full-width':	$sidebar_left = $sidebar_right = "display:none;";	break;
					case 'with-both-sibebar':	$sidebar_left = $sidebar_right = ''; break;
					case 'with-left-sidebar':	$sidebar_left = ""; $sidebar_right = 'display:none';	break;
					case 'with-right-sidebar':  $sidebar_left = 'display:none'; $sidebar_right = ""; break;
				endswitch;?>
                
                <div id="left-widget-area" class="widget-area-options" style="<?php echo $sidebar_left;?>">
                    <div class="custom-box">
                        <div class="column one-sixth">   
                ...
                <div id="right-widget-area" class="widget-area-options" style="<?php echo $sidebar_right;?>">
                    <div class="custom-box">
                        <div class="column one-sixth">   
                ...
                <div class="custom-box">
                    ...
                    <?php if(array_key_exists("portfolio-categories",$tpl_default_settings)):
							 ...
							 foreach($exclude_cats as $cats):
								echo "<!-- Category Drop Down Container -->
									  <div class='multidropdown'>";
								echo  dttheme_gallery_categorylist("portfolio,cats",$cats,"multidropdown");
								echo "</div><!-- Category Drop Down Container end-->";		
							 endforeach;
						  else:
							echo "<!-- Category Drop Down Container -->";
							echo "<div class='multidropdown'>";
							echo  dttheme_gallery_categorylist("portfolio,cats","","multidropdown");
							echo "</div><!-- Category Drop Down Container end-->";
						   endif;?>
	...
	function page_meta_save($post_id){
		...
		if ( defined('DOING_AUTOSAVE') && DOING_AUTOSAVE ) 	return $post_id;
			...
			if(isset($_POST["page_template"]) && ( 'default' == $_POST["page_template"]) || 'tpl-home.php' == $_POST["page_template"] || 'tpl-fullwidth.php' == $_POST["page_template"]) :
