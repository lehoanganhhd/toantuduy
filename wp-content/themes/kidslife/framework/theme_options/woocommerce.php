...
<?php  if( class_exists('woocommerce') ) : ?>
                ...
                <div class="box-content">
                    ...
                    <div class="hr_invisible"> </div>
                    <div class="bpanel-option-set">
                        <ul id="dt-product" class="bpanel-post-layout bpanel-layout-set">
                    ...
                    <?php $sb_layout = dttheme_option('woo',"product-layout");
                        ...
                        <div id="bpanel-widget-area-options" <?php echo 'class="dt-product" '.$sidebar_both;?>>
                            ...
                            <div id="left-sidebar-container" class="bpanel-page-left-sidebar" <?php echo $sidebar_left; ?>>
                                ...
                                <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                    ...
                                    <?php dttheme_switch("",'woo','disable-shop-everywhere-left-sidebar-in-product-detail');?>
                            ...
                            <div id="right-sidebar-container" class="bpanel-page-right-sidebar" <?php echo $sidebar_right; ?>>
                                ...
                                <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                    ...
                                    <?php dttheme_switch("",'woo','disable-shop-everywhere-right-sidebar-in-product-detail');?>
                ...
                <div class="box-content">
                    ...
                    <div class="hr_invisible"> </div>
                    <div class="bpanel-option-set">
                        <ul id="dt-product-category" class="bpanel-post-layout bpanel-layout-set">
                        <?php $layout = array('content-full-width'=>'without-sidebar','with-left-sidebar'=>'left-sidebar','with-right-sidebar'=>'right-sidebar','with-both-sidebar' => 'both-sidebar');
                    ...
                    <?php $sb_layout = dttheme_option('woo',"product-category-layout");
                        $sidebar_both = $sidebar_left = $sidebar_right = '';
                        if($sb_layout == 'content-full-width') {
                            $sidebar_both = 'style="display:none;"'; 
                        } elseif($sb_layout == 'with-left-sidebar') {
                        ...
                        <div id="bpanel-widget-area-options" <?php echo 'class="dt-product-category" '.$sidebar_both;?>>

                            <div id="left-sidebar-container" class="bpanel-page-left-sidebar" <?php echo $sidebar_left; ?>>
                                <!-- 2. Every Where Sidebar Left Start -->
                                <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                    <h6><?php _e('Disable Every Where Sidebar Left','dt_themes');?></label></h6>
                                    <?php dttheme_switch("",'woo','disable-shop-everywhere-left-sidebar-in-product-category-archive');?>
                                </div><!-- Every Where Sidebar Left End-->
                            </div>
                            ...
                            <div id="right-sidebar-container" class="bpanel-page-right-sidebar" <?php echo $sidebar_right; ?>>
                                ...
                                <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                    <h6><?php _e('Disable Every Where Sidebar Right','dt_themes');?></label></h6>
                                    <?php dttheme_switch("",'woo','disable-shop-everywhere-right-sidebar-in-product-category-archive');?>
                                </div><!-- Every Where Sidebar Right End-->
                            </div>
                        </div>
                ...
                <div class="box-content">
                    ...
                    <div class="hr_invisible"> </div>
                    <div class="bpanel-option-set">
                        <ul id="dt-product-tag" class="bpanel-post-layout bpanel-layout-set">
                        <?php $layout = array('content-full-width'=>'without-sidebar','with-left-sidebar'=>'left-sidebar','with-right-sidebar'=>'right-sidebar','with-both-sidebar' => 'both-sidebar');
                    ...
                    <?php $sb_layout = dttheme_option('woo',"product-category-layout");
                        ...
                        <div id="bpanel-widget-area-options" <?php echo 'class="dt-product-tag" '.$sidebar_both;?>>

                            <div id="left-sidebar-container" class="bpanel-page-left-sidebar" <?php echo $sidebar_left; ?>>
                                <!-- 2. Every Where Sidebar Left Start -->
                                <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                    <h6><?php _e('Disable Every Where Sidebar Left','dt_themes');?></label></h6>
                                    <?php dttheme_switch("",'woo','disable-shop-everywhere-left-sidebar-in-product-tag-archive');?>
                                </div><!-- Every Where Sidebar Left End-->
                            </div>
                            ...
                            <div id="right-sidebar-container" class="bpanel-page-right-sidebar" <?php echo $sidebar_right; ?>>
                                ...
                                <div id="page-commom-sidebar" class="bpanel-sidebar-section custom-box">
                                    <h6><?php _e('Disable Every Where Sidebar Right','dt_themes');?></label></h6>
                                    <?php dttheme_switch("",'woo','disable-shop-everywhere-right-sidebar-in-product-tag-archive');?>
                                </div><!-- Every Where Sidebar Right End-->
                            </div>
                        </div>
