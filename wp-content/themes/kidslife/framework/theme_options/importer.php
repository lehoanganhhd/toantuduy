        ...
        <div id="tab1" class="tab-content">
            ...
            <div class="bpanel-box">
                ...
                <div class="box-content dttheme-import">
                    <p class="note">
                        <?php esc_html_e('Before starting the import, you need to install all plugins that you want to use.', 'dt_themes');?>
                        <br/>
                        <?php esc_html_e('If you are planning to use the shop, please install WooCommerce plugin.', 'dt_themes');?>
                    </p>
                    ...
                    <?php foreach($avail_demos as $avail_demo_key => $avail_demo) { ?>
                    		<div class="dttheme-demos <?php echo esc_attr($avail_demo_key); ?>-demo hide">
                                ...
                                <div class="column two-third last">
			                        ...
			                        <a class="lnk-onlinedemo" href="//wedesignthemes.com/themes/dt-kidslife/" target="_blank"><?php esc_html_e('Online Demo', 'dt_themes');?></a>
                                </div>
                                <div class="hr_invisible"> </div>
                                ...
                                <div class="row-content hide">
                                    ...
                                    <div class="column two-third last">
                                        <select name="content" class="medium dt-chosen-select">
                                            ...
                                            <option value="Contactform"><?php esc_html_e('Contact Form', 'dt_themes');?></option>
                                            <option value="pages"><?php esc_html_e('Pages', 'dt_themes');?></option>
                                            <option value="posts"><?php esc_html_e('Posts', 'dt_themes');?></option>
                                            <option value="portfolios"><?php esc_html_e('Portfolios', 'dt_themes');?></option>
