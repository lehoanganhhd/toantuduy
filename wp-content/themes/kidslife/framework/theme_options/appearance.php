   ...
   <div class="bpanel-main-content">
      <ul class="sub-panel"><?php
         ...
         foreach($sub_menus as $menu):?>
            <li><a href="<?php echo $menu['link']?>"><?php echo $menu['title'];?></a></li><?php
         endforeach?>
      </ul>
      ...
      <div id="appearance-header" class="tab-content">
         <div class="bpanel-box">
            <div class="box-title"><h3><?php _e('Header Style','dt_themes');?></h3></div>
            <div class="box-content">

               <h6><?php esc_html_e('Header Types', 'dt_themes'); ?></h6>
               <p class="note no-margin"> <?php esc_html_e("Choose the header type", 'dt_themes');?> </p>
               <div class="hr_invisible"> </div>
               <div class="bpanel-option-set">
                  <ul class="bpanel-layout-set bpanel-post-layout"><?php
                     $htypes = array(  "header1" => "header1.png",
                        "header2" => "header2.png",
                        "header3" => "header3.png",
                        "header4" => "header4.png",
						"header5" => "header5.png");
                     ...
                     foreach( $htypes as $key => $htype):
                        $class = ( $key ==  dttheme_option('appearance','header-type')) ? " class='selected' " : "";?>
                        <li class="headerlayout">
                           <a href="#" rel="<?php echo esc_attr($key);?>" <?php echo $class;?>>
                              <img src="<?php echo IAMD_FW_URL . "theme_options/images/headers/{$htype}";?>" />
                           </a>
                        </li><?php
                     endforeach;?>
                  </ul>
               ...
               <div class="column one-half">
                  <h6><?php esc_html_e('Header Left Content', 'dt_themes'); ?></h6>
                  <div class="column one-column">
                     <?php $checked = ( "true" ==  dttheme_option('appearance','enable-header-left-content') ) ? ' checked="checked"' : ''; ?>
                     <?php $switchclass = ( "true" ==  dttheme_option('appearance','enable-header-left-content') ) ? 'checkbox-switch-on' :'checkbox-switch-off'; ?>
                     <div data-for="mytheme-appearance-enable-header-left-content" class="checkbox-switch <?php echo esc_attr($switchclass);?>"></div>
                     <input class="hidden" id="mytheme-appearance-enable-header-left-content" name="mytheme[appearance][enable-header-left-content]" type="checkbox" value="true" <?php echo $checked;?> />
                  </div>
                  <div class="column one-column last">
                     <p class="note"><?php esc_html_e('YES! to show header left content for this site.', 'dt_themes');?></p>
                  </div>
               </div>
               <div class="column one-half last">
                  <div class="column one-column">
                     <textarea id="mytheme[appearance][header-left-content]" name="mytheme[appearance][header-left-content]"><?php echo stripslashes(dttheme_option('appearance', 'header-left-content'));?></textarea>
                     <p class="note"><?php esc_html_e('This content will appear left side of header', 'dt_themes');?></p>
                  </div>               
               </div>
               <div class="hr_invisible"> </div>
               <div class="hr_invisible"> </div>
               ...
               <div class="column one-half">
                  <h6><?php esc_html_e('Header Right Content', 'dt_themes'); ?></h6>
                  <div class="column one-column">
                     <?php $checked = ( "true" ==  dttheme_option('appearance','enable-header-right-content') ) ? ' checked="checked"' : ''; ?>
                     <?php $switchclass = ( "true" ==  dttheme_option('appearance','enable-header-right-content') ) ? 'checkbox-switch-on' :'checkbox-switch-off'; ?>
                     <div data-for="mytheme-appearance-enable-header-right-content" class="checkbox-switch <?php echo esc_attr($switchclass);?>"></div>
                     <input class="hidden" id="mytheme-appearance-enable-header-right-content" name="mytheme[appearance][enable-header-right-content]" type="checkbox" value="true" <?php echo $checked;?> />
                  </div>
                  <div class="column one-column last">
                     <p class="note"><?php esc_html_e('YES! to show header right content for this site.', 'dt_themes');?></p>
                  </div>
               </div>
               <div class="column one-half last">
                  <div class="column one-column">
                     <textarea id="mytheme[appearance][header-right-content]" name="mytheme[appearance][header-right-content]"><?php echo stripslashes(dttheme_option('appearance', 'header-right-content'));?></textarea>
                     <p class="note"><?php esc_html_e('This content will appear right side of header', 'dt_themes');?></p>
                  </div>               
               </div>
               ...
               <div class="column one-half">
                  <h6><?php esc_html_e('Header Top Content', 'dt_themes'); ?></h6>
                  <div class="column one-column">
                     <?php $checked = ( "true" ==  dttheme_option('appearance','enable-header-top-content') ) ? ' checked="checked"' : ''; ?>
                     <?php $switchclass = ( "true" ==  dttheme_option('appearance','enable-header-top-content') ) ? 'checkbox-switch-on' :'checkbox-switch-off'; ?>
                     <div data-for="mytheme-appearance-enable-header-top-content" class="checkbox-switch <?php echo esc_attr($switchclass);?>"></div>
                     <input class="hidden" id="mytheme-appearance-enable-header-top-content" name="mytheme[appearance][enable-header-top-content]" type="checkbox" value="true" <?php echo $checked;?> />
                  </div>
                  <div class="column one-column last">
                     <p class="note"><?php esc_html_e('YES! to show header top content for this site.', 'dt_themes');?></p>
                  </div>
               </div>
               <div class="column one-half last">
                  <div class="column one-column">
                     <textarea id="mytheme[appearance][header-top-content]" name="mytheme[appearance][header-top-content]"><?php echo stripslashes(dttheme_option('appearance', 'header-top-content'));?></textarea>
                     <p class="note"><?php esc_html_e('This content will appear top side of header', 'dt_themes');?></p>
                  </div>               
               </div>                              
