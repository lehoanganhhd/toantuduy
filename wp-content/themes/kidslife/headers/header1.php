<?php $top_enable = dttheme_option('appearance','enable-header-top-content');
	...
	if( !is_null( $top ) || $top ) :
    	...
    	<div class="top-bar header1"><div class="container"><?php echo $top; ?></div></div><?php
	endif;?><!-- **Header** -->
<header id="header" class="header1">
	...
	<div class="container">
		<div class="logo"><?php
			...
			if( $lhs || $rhs ):?>
            	<div class="header-more-info contact-details"><?php
				if( $lhs ):?>
	...
	<div id="menu-container">
    	<div class="container">
            ...
            <?php echo do_shortcode('[social position="header"/]'); ?>
        </div>
	</div>
    <!--menu-container ends-->
</header><!-- **Header - End** -->