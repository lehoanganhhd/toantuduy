		...
		for ( var h in c) {
			...
			if (d.length > 0) {
				...
				g += "<br>[dt_sc_"
						+ e
						+ "] "
						+ "<br>[dt_sc_pricing_table_item type='type1' title='Title' image='http://placehold.it/98x87&text=DT' variation='"+variation+"' button_text='View All' button_link='#' currency='$' price='15' per='month' "
